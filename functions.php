...
function basic_shop_theme_scripts() {
	...
	// Front page product slider (Swiper)
	if ( is_front_page() ) {
		// Swiper CSS
		wp_enqueue_style(
			'swiper',
		...
		// Front page product slider script
		wp_enqueue_script(
			'basic-shop-theme-front-page-slider',
			get_template_directory_uri() . '/assets/js/front-page-product-slider.js',
			array( 'swiper' ),
			'1.0.0',
			true
		);
