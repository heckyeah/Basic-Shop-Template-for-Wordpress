...
<?php else : ?>
	...
	<form method="post" class="woocommerce-EditAddressForm edit-address" novalidate>
		...
		<h2 class="woocommerce-EditAddressForm-title"><?php echo apply_filters( 'woocommerce_my_account_edit_address_title', $page_title, $load_address ); ?></h2><?php // @codingStandardsIgnoreLine ?>
		...
		<div class="woocommerce-address-fields">
			...
			<p class="woocommerce-address-fields__submit">
